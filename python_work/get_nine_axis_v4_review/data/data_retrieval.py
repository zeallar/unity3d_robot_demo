...
PHYPHOX_URL = "http://192.168.100.104/get?accX&accY&accZ&gyroX&gyroY&gyroZ&magX&magY&magZ"
...
class DataRetrieval:
    ...
    def convert_to_physical_data(self, data):
        ...
        gyro_sensitivity = 8.75 * 0.001 * (3.14159265358979323846 / 180.0); #单位：rad/s/LSB
